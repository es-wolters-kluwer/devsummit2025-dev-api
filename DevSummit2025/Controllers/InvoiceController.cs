...
namespace DevSummit2025.Controllers
{
    ...
    public class InvoiceController(IServiceSaleInvoice service) : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAsync()
        {
            ...
            string url = $"{urlBaseApi}/services/api/saleInvoices?pageNumber=1&pageSize=50&orderBy=date%20Desc&filter=";
        ...
        public async Task<IActionResult> GetNew()
        {
            ...
            string url = $"{urlBaseApi}/services/api/saleInvoices/new";
            HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Get, url);
            request.Headers.Add("Accept", "application/json");
            request.Headers.Add("Accept-Language", "es-ES,es;q=0.9,pt;q=0.8");
            request.Headers.Add("Authorization", bearer);
        ...
        public async Task<IActionResult> PostAsync()
        {
            ...
            //string url = $"{urlBaseApi}/services/api/saleInvoices";
